...
def get_forks(shared, i):   # i je pozicia filozofa
    ...
    print("Filozof", i, "zobral PRAVU vidlicku")
    sleep(0.0001)   # ABY NASTAL DEADLOCK
    shared.forks[shared.left(i)].wait()
    print("Filozof", i, "zobral LAVU vidlicku")
...
# UVIAZNUTIE NASTANE KED SI VLAKNA NARAZ ZOBERU PRAVU VIDLICKU
